...
public record UpdateTransactionRequest(
        @NotNull(message = "não pode estar em branco") @Pattern(regexp = ".*\\S.*", message = "não pode estar em branco") String description,
        @NotNull(message = "não pode estar em branco") TransactionType type,
